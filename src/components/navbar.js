          ...
          <div className="flex flex-col p-4 space-y-4 text-center">
            {isLoggedIn ? (
              <>
                <Link
                  href="/jobs"
                  className={`block py-2 hover:text-white transition ${isActive("/jobs") ? "text-white font-semibold" : "text-zinc-400"
                    }`}
                >
                  Jobs
                </Link>
                ...
                <Link
                  href="/profile"
                  className={`block py-2 hover:text-white transition ${isActive("/profile") ? "text-white font-semibold" : "text-zinc-400"
                    }`}
                >
                  Profile
                </Link>
              ...
              <>
                ...
                <Link
                  href="/signup"
                  className={`block py-2 hover:text-white transition ${isActive("/signup") ? "text-white font-semibold" : "text-zinc-400"
                    }`}
                >
                  Signup
                </Link>
                <Link
                  href="/login"
                  className={`block py-2 hover:text-white transition ${isActive("/login") ? "text-white font-semibold" : "text-zinc-400"
                    }`}
                >
                  Login
                </Link>
