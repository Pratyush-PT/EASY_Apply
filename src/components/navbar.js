...
import { Menu, X, Briefcase, User, LogOut, Home, UserPlus, LogIn, CheckCircle } from 'lucide-react'
    ...
    return (
        <nav
            className={cn(
                ...
                scrolled || isOpen ? "bg-black/80 backdrop-blur-xl border-white/5 shadow-2xl" : "bg-transparent"
            )}
        >
                ...
                <div className="hidden md:flex items-center gap-2">
                    {isLoggedIn ? (
                        <>
                            ...
                            <NavLink href="/applications" icon={CheckCircle}>My Applications</NavLink>
                        ...
                        <div className="flex flex-col p-6 space-y-4">
                            {isLoggedIn ? (
                                <>
                                    ...
                                    <MobileLink href="/applications" icon={CheckCircle}>Applications</MobileLink>
                                ...
                                <>
                                    ...
                                    <MobileLink href="/signup" icon={UserPlus}>Signup</MobileLink>
                                    <MobileLink href="/login" icon={LogIn}>Login</MobileLink>
                                </>
                            )}
                        </div>
                    </motion.div>
