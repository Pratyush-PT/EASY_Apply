        ...
        <nav className='w-full bg-zinc-900 shadow-lg border-b border-zinc-800 relative z-50'>
            <div className='px-6 py-4 flex justify-between items-center'>
                ...
                <div className='hidden md:flex gap-6 text-sm font-medium text-zinc-300 items-center'>
                    <Link
                        href='/admin'
                        className={`hover:text-white transition ${isActive('/admin') && pathname === '/admin'
            ...
            {isOpen && (
                <div className='md:hidden bg-zinc-900 border-t border-zinc-800 absolute w-full left-0 shadow-xl'>
                    <div className='flex flex-col p-4 space-y-4 text-center'>
                        <Link
                            href='/admin'
                            className={`block py-2 hover:text-white transition ${isActive('/admin') && pathname === '/admin'
                                    ? 'text-white font-semibold'
                                    : 'text-zinc-400'
                                }`}
                        >
                        ...
                        <Link
                            href='/admin/jobs'
                            className={`block py-2 hover:text-white transition ${isActive('/admin/jobs')
                                    ? 'text-white font-semibold'
                                    : 'text-zinc-400'
                                }`}
                        >
                        ...
                        <Link
                            href='/admin/applications'
                            className={`block py-2 hover:text-white transition ${isActive('/admin/applications')
                                    ? 'text-white font-semibold'
                                    : 'text-zinc-400'
                                }`}
                        >
