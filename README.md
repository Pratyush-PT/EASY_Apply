...
**Easy Apply** is a college-based placement platform that makes applying for on-campus jobs simple and hassle-free for students.
...
- **Tools**: [ESLint](https://eslint.org/), [PostCSS](https://postcss.org/)
